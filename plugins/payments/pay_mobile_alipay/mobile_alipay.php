 ...
 * @file mobile_alipay.php
 * @brief 支付宝手机网站支付
 * @author nswe
 * @date 2019/6/25 15:21:52
 * @version 5.6
 */
require_once dirname(__FILE__).'/service/AlipayTradeService.php';
class mobile_alipay extends paymentPlugin
{
	//支付插件名称
    public $name = '手机网站支付';
	...
	public function doPay($sendData)
	{
    	 ...
    	 * @return $response 支付宝返回的信息
     	 */
    	$response = $aop->wapPay($payRequestBuilder,$sendData['return_url'],$sendData['notify_url']);
    	return;
	}
