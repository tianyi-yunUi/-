				...
				<div class="log_box">
					...
					<div class="gray_box">
						<div class="box">
							...
							<strong>安装选择</strong>
							<label><input class="radio" type="radio" name='install_type' value='all' />带测试数据版本【<a href="http://www.aircheng.com/content-107.html" target="_blank" style="color:red">必须提前手动下载商品图片包108MB</a>】</label><br />
